#!/bin/bash
#
# Script to install iris-intelowl-module to IRIS Docker containers
...
echo "================================================"
echo "Installing iris-intelowl-module to IRIS containers"
echo "================================================"

# Build the wheel package
echo "[1/5] Building wheel package..."
cd "$MODULE_DIR"
rm -rf build dist *.egg-info iris_intelowl_module.egg-info
...
echo "3. Add module 'IrisIntelOwl+' (package: iris_intelowl_module_2)"
echo "4. Configure IntelOwl URL and API Key"
